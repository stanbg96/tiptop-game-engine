...
func spawn_piano(pos: Vector3) -> Node3D:
...
func spawn_car(pos: Vector3) -> Node3D:
...
func spawn_wall(pos: Vector3) -> Node3D:
...
func spawn_from_json(recipe: Dictionary, pos: Vector3) -> Node3D:
